...
order = ['01_ОБЪЕКТЫ','02_СТРАТЕГИЯ','03_ДЕЙСТВИЯ','04_ВОРОНКА','05_СТАТИСТИКА','06_ПЛАН_ФАКТ','07_ОТЧЕТ','08_СПРАВОЧНИКИ','09_ДЭШБОРД','10_НАСТРОЙКИ','11_КОНТРОЛЬ','12_ИСТОРИЯ','13_АРХИВ_ОТЧЕТОВ']
